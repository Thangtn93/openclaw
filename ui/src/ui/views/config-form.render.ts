...
export const SECTION_META: Record<string, { label: string; description: string }> = {
  ...
  update: { label: "Cập nhật", description: "Thiết lập tự cập nhật và kênh phát hành" },
  agents: { label: "Agents", description: "Cấu hình agent, model và danh tính" },
  auth: { label: "Xác thực", description: "Khoá API và profile xác thực" },
  channels: {
    label: "Kênh",
    description: "Kênh nhắn tin (Telegram, Discord, Slack, ...)",
  },
  messages: { label: "Tin nhắn", description: "Thiết lập xử lý và định tuyến tin nhắn" },
  commands: { label: "Lệnh", description: "Slash command tuỳ chỉnh" },
  hooks: { label: "Hooks", description: "Webhook và hook sự kiện" },
  skills: { label: "Kỹ năng", description: "Gói kỹ năng và năng lực" },
  tools: { label: "Công cụ", description: "Cấu hình công cụ (trình duyệt, tìm kiếm, ...)" },
  gateway: { label: "Gateway", description: "Thiết lập server gateway (cổng, xác thực, bind)" },
  wizard: {
    label: "Trình hướng dẫn",
    description: "Trạng thái và lịch sử trình hướng dẫn thiết lập",
  },
  // Additional sections
  meta: { label: "Metadata", description: "Metadata của gateway và thông tin phiên bản" },
  logging: { label: "Ghi log", description: "Mức log và cấu hình đầu ra" },
  browser: { label: "Trình duyệt", description: "Thiết lập tự động hoá trình duyệt" },
  ui: { label: "Giao diện", description: "Tuỳ chọn giao diện người dùng" },
  models: { label: "Model", description: "Cấu hình model AI và nhà cung cấp" },
  bindings: { label: "Phím tắt", description: "Gán phím và phím tắt" },
  broadcast: { label: "Phát thông báo", description: "Thiết lập broadcast và thông báo" },
  audio: { label: "Âm thanh", description: "Thiết lập vào/ra âm thanh" },
  session: { label: "Phiên", description: "Quản lý và lưu trữ phiên" },
  cron: { label: "Cron", description: "Tác vụ theo lịch và tự động hoá" },
  web: { label: "Web", description: "Thiết lập web server và API" },
  discovery: { label: "Discovery", description: "Khám phá dịch vụ và mạng" },
  canvasHost: { label: "Canvas Host", description: "Render và hiển thị canvas" },
  talk: { label: "Giọng nói", description: "Thiết lập voice và speech" },
  plugins: { label: "Plugin", description: "Quản lý plugin và extension" },
  diagnostics: {
    label: "Chẩn đoán",
    description: "Instrumentation, OpenTelemetry và thiết lập cache-trace",
  },
  cli: { label: "CLI", description: "Banner CLI và hành vi khởi động" },
  secrets: { label: "Secrets", description: "Cấu hình secret provider" },
  acp: {
    label: "ACP",
    description: "Thiết lập runtime và streaming của Agent Communication Protocol",
  },
  mcp: { label: "MCP", description: "Định nghĩa server Model Context Protocol" },
};
